...
export const intakeSubmissionSchema = z.object({
  ...
  addonIds: z.array(z.string()), discountIds: z.array(z.string()), reviewParticipation: z.boolean().default(false), visaCountryId: z.string().nullable().default(null), pickupId: z.string(),
...
export type IntakeRecord = IntakeSubmission & {
