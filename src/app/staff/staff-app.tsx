...
import { statusLabels } from "@/lib/intakes/types";
...
const badges: Record<IntakeStatus,string> = { pending_review: "badge-orange", completed: "badge-green" };
